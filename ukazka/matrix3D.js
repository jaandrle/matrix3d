...
//document.getElementById("doc_0").innerHTML= `&nbsp;&nbsp;&nbsp;&nbsp;elements //elementy buď klasické JavaScriptové, nebo jQuery<br>
//&nbsp;&nbsp;&nbsp;&nbsp;selector //string pro výběr<br>
//&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>...elemen je potřeba vybrat buť pomocí 'elements', nebo 'selector' (preferovaná verze)</b><br>
//&nbsp;&nbsp;&nbsp;&nbsp;directly //bez efektu`;

//document.getElementById("doc_1").innerHTML= `&nbsp;&nbsp;&nbsp;&nbsp;_this.write= function(matrix){ ... //zápis buď zadané matice/transformace 'matrix', nebo interní matice
//<br>&nbsp;&nbsp;&nbsp;&nbsp;_this.returnStyle= function(matrix){ ... //vypíše kompletní zápis stylu aktuální matice nebo 'matrix'
//<br>&nbsp;&nbsp;&nbsp;&nbsp;_this.returnMatrix= function(){ ... // vypíše aktuální matici
//<br>&nbsp;&nbsp;&nbsp;&nbsp;_this.clear= function(){ ... //resetuje trasformace
//<br>&nbsp;&nbsp;&nbsp;&nbsp;_this.t= { ...//schraňuje všechny transformační funkce
//<br>&nbsp;&nbsp;&nbsp;&nbsp;_this.chain= function(){... //umožní řetězení metod`;

//document.getElementById("doc_2").innerHTML= `&nbsp;&nbsp;&nbsp;&nbsp;settings={//nastavování jednotek
//<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;angle ["radians" : "degrees"] - default stupně
//<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;zoom ["original" : "percent"] - defautt procenta (u originálu potřeba normovat na 1)
//<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;scroll ["original" : "thousandth"] - default tisíciny
//<br>&nbsp;&nbsp;&nbsp;&nbsp;}
//<br>&nbsp;&nbsp;&nbsp;&nbsp;const //konstanty
//<br>&nbsp;&nbsp;&nbsp;&nbsp;t //přístup k transformačním funkcím
//<br>&nbsp;&nbsp;&nbsp;&nbsp;product //násobení matic === kombinování transformací`;

//document.getElementById("doc_3").innerHTML= `&nbsp;&nbsp;&nbsp;&nbsp;diagonal(...d){//vytvori diagonalni matici s (x,y,z,a) na diagonále
//<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    ...parametr 'd' je pole:
//<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    - prázdné pro (x,y,z,a)=(1,1,1,1)
//<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    - jednoprvkové pokud (x,y,z,a)=(d[0],d[0],d[0],1)
//<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    - tříprvkové pro (x,y,z,a)=(d[0],d[1],d[2],1)
//<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    - čtyřprvkové
//<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    - jinak chyba
//<br>&nbsp;&nbsp;&nbsp;&nbsp;identity(){//alias pro 'this.diagonal()'
//<br>&nbsp;&nbsp;&nbsp;&nbsp;zoom(z){//alias pro 'this.diagonal(z)'
//<br>&nbsp;&nbsp;&nbsp;&nbsp;zoomYZ(z){//alias pro 'this.diagonal(1,z,z)'
//<br>&nbsp;&nbsp;&nbsp;&nbsp;zoomXZ(z){//alias pro 'this.diagonal(z,1,z)'
//<br>&nbsp;&nbsp;&nbsp;&nbsp;zoomXYZ(...z){//alias pro 'this.diagonal(zx,zy,zz)'
//<br>&nbsp;&nbsp;&nbsp;&nbsp;zoomXY(z){//alias pro 'this.diagonal(z,z,1)'
//<br>&nbsp;&nbsp;&nbsp;&nbsp;mirrorXZ(){//alias pro 'this.diagonal(1,-1,1)'
//<br>&nbsp;&nbsp;&nbsp;&nbsp;mirrorYZ(){//alias pro 'this.diagonal(-1,1,-1)'
//<br>&nbsp;&nbsp;&nbsp;&nbsp;mirrorXY(){//alias pro 'this.diagonal(1,-1,1)'
//<br>&nbsp;&nbsp;&nbsp;&nbsp;rotate(x=0,y=0,z=0){//rotace dle příslušných os
//<br>&nbsp;&nbsp;&nbsp;&nbsp;rotateX(d){//alias pro 'this.rotate(d,0,0)'
//<br>&nbsp;&nbsp;&nbsp;&nbsp;rotateY(d){//alias pro 'this.rotate(0,d,0)'
//<br>&nbsp;&nbsp;&nbsp;&nbsp;rotateZ(d){//alias pro 'this.rotate(0,0,d)'
//<br>&nbsp;&nbsp;&nbsp;&nbsp;translate(x=0,y=0,z=0){//posun v příslušních osách
//<br>&nbsp;&nbsp;&nbsp;&nbsp;translateX(t){//alias pro 'this.translate(t,0,0)'
//<br>&nbsp;&nbsp;&nbsp;&nbsp;translateY(t){//alias pro 'this.translate(0,t,0)'
//<br>&nbsp;&nbsp;&nbsp;&nbsp;translateZ(t){//alias pro 'this.translate(0,0,t)'
//<br>&nbsp;&nbsp;&nbsp;&nbsp;skew(x=0,y=0,z=0){
//<br>&nbsp;&nbsp;&nbsp;&nbsp;scroll(x=0,y=0,z=0){
//<br>&nbsp;&nbsp;&nbsp;&nbsp;matrix(m){//použití externí matice (pole) 'm' v následujícíxh formátech:
//<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    - [1,...,16] = plná matice 3d transformace + posuvy
//<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    - [[1,...,4],...,[13,...,16]] = plná matice 3d transformace + posuvy
//<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    - [1,...,9] = 3d trasformace jsou doplněny nulovými posuvy
//<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    - [[1,...,3],...,[7,...,9]] = 3d trasformace jsou doplněny nulovými posuvy
//<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    - [1,...,4] = diagonální matice
//<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    - [1,...,3] = diagonální matice doplněna 1 jedničkou na posledním místě`;

const $Mc_1= $M({selector: "#c_1"});
const matice_rotace_45= $M.t.rotateZ(45);
console.log(matice_rotace_45);//= ${matice_rotace_45}
$Mc_1.write(matice_rotace_45);
document.getElementById("c_1_out").innerText= `const $Mc_1= $M({selector: "#c_1"});
const matice_rotace_45= $M.t.rotateZ(45);
console.log(matice_rotace_45);//= ${matice_rotace_45}
$Mc_1.write(matice_rotace_45);`;

const $Mc_2= $M({selector: "#c_2"});
const matice_rotace_90= $M.product(matice_rotace_45,matice_rotace_45);
console.log(matice_rotace_90);//= ${matice_rotace_90}
$Mc_2.write(matice_rotace_90);
document.getElementById("c_2_out").innerText= `const $Mc_2= $M({selector: "#c_2"});
const matice_rotace_90= $M.product(matice_rotace_45,matice_rotace_45);
console.log(matice_rotace_90);//= ${matice_rotace_90}
$Mc_2.write(matice_rotace_90);`;

const $Mc_3= $M({selector: "#c_3"});
$Mc_3.t.rotateZ(5);
$Mc_3.t.scroll(0,2.5,0);
$Mc_3.write();
document.getElementById("c_3_out").innerText= `const $Mc_3= $M({selector: "#c_3"});
$Mc_3.t.rotateZ(5);
$Mc_3.t.scroll(0,2.5,0);
$Mc_3.write();`;

const $Mc_4= $M({selector: "#c_4"});
$Mc_4.chain()
    .rotateZ(5)
    .scroll(0,2.5,0)
    .skew(0,-10,0)
    .write();
document.getElementById("c_4_out").innerHTML= `const $Mc_4= $M({selector: "#c_4"});
<br>$Mc_4.chain()
<br>&nbsp;&nbsp;&nbsp;&nbsp;.rotateZ(5)
<br>&nbsp;&nbsp;&nbsp;&nbsp;.scroll(0,2.5,0)
<br>&nbsp;&nbsp;&nbsp;&nbsp;.skew(0,-10,0)
...
const $Mc_5= $M({selector: "#c_5"});
$Mc_5.chain()
    .matrix([
        1.0115626070619197,-0.0871557427479406,0.015367908970199016,-0.00021788935686985151,
        -0.08850026056493579,0.9961946980917208,-0.1756560033128764,0.002490486745229302,
        0,0,1,0,
        0,0,0,1
    ])
    .rotateZ(45)
    .write();
document.getElementById("c_5_out").innerHTML= `const $Mc_5= $M({selector: "#c_5"});
<br>&nbsp;&nbsp;&nbsp;&nbsp;$Mc_5.chain()
<br>&nbsp;&nbsp;&nbsp;&nbsp;    .matrix([
<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    1.0115626070619197,-0.0871557427479406,0.015367908970199016,-0.00021788935686985151,
<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    -0.08850026056493579,0.9961946980917208,-0.1756560033128764,0.002490486745229302,
<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    0,0,1,0,
<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    0,0,0,1
<br>&nbsp;&nbsp;&nbsp;&nbsp;    ])
<br>&nbsp;&nbsp;&nbsp;&nbsp;    .rotateZ(45)
